...
class AppDelegate: UIResponder, UIApplicationDelegate, WCSessionDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if(CLLocationManager.authorizationStatus() != CLAuthorizationStatus.authorizedAlways) {
            ...
            let rootViewController: UIViewController = storyboard.instantiateViewController(withIdentifier: LOCATION_REQUEST_VIEW)
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        NotificationCenter.default.post(name: Notification.Name(rawValue: "DID_ENTER_BACKGROUND"), object: self)
    }
    
    func applicationWillEnterForeground(_ application: UIApplication) {
        // Called as part of the transition from the background to the inactive state; here you can undo many of the changes made on entering the background.
        NotificationCenter.default.post(name: Notification.Name(rawValue: "WILL_ENTER_FOREGROUND"), object: self)
    }
